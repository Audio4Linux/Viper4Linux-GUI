...
printf "Getting latest release tag... "
  latestrelease=$(curl --silent "https://api.github.com/repos/Audio4Linux/Audio4Linux/releases/latest" |grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
...
wget -O viper-gui https://github.com/ThePBone/Audio4Linux/releases/download/$latestrelease/viper-gui -q --show-progress
...
wget -O viper-gui.png https://raw.githubusercontent.com/ThePBone/Audio4Linux/master/viper.png -q --show-progress
...
Comment=Official UI for Viper4Linux2
Keywords=equalizer
