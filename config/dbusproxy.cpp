...
DBusProxy::DBusProxy()
{
    ...
    if(!dbConnection.connect("me.noahbliss.ViperFx",
                        "/me/noahbliss/ViperFx",
                        "me.noahbliss.ViperFx", "PropertiesCommitted",
...
QVariantMap DBusProxy::FetchPropertyMap(){
    if (m_dbInterface->isValid()) {
        QDBusMessage message = QDBusMessage::createMethodCall("me.noahbliss.ViperFx", "/me/noahbliss/ViperFx", QLatin1String("org.freedesktop.DBus.Properties"), QLatin1String("GetAll"));
        QList<QVariant> arguments;
        arguments << "me.noahbliss.ViperFx";
